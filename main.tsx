  ...
  return (
    <div className="billiards-app min-h-screen p-4 text-white sm:p-6">
      ...
      <div className="mx-auto max-w-7xl space-y-6">
          ...
          {isPublicRoute ? (
            <div className="flex flex-col items-start gap-3 lg:items-end">
              <div className="rounded-2xl border border-cyan-300/20 bg-cyan-300/10 px-4 py-3 text-sm font-semibold text-cyan-100">
                <Globe className="mr-2 inline h-4 w-4" /> Public display mode
              </div>
              <div className="max-w-sm text-left text-sm text-slate-400 lg:text-right">
                Admin controls are hidden from shared public links.
              </div>
            </div>
          ) : (
          <div className="flex flex-col items-start gap-3 lg:items-end">
        ...
        {!tournament && isPublicRoute ? (
          <Panel className="border-cyan-300/15 bg-black/35">
            <div className="text-xs uppercase tracking-[0.24em] text-cyan-200/80">Public View</div>
            <div className="mt-2 text-3xl font-bold">No live tournament yet</div>
            <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-300">
              The public bracket will appear here after the tournament director creates or loads a bracket from the admin view.
            </p>
          </Panel>
        ) : !tournament ? (
